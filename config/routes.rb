...
Rails.application.routes.draw do
  ...
  resources :statuses
  resources :people_disciplines
  resources :disciplines
  resources :people_ratings
  resources :ratings
  ...
  scope '/products' do
    get '/categories/:category', to: 'products#category_hash', as: :category_hash
    get '/categories/:category_id/custom_field_ids', to: 'products#custom_field_ids', as: :category_custom_fields
    get '/categories/:category/manufacturers', to: 'products#get_manufacturers', as: :category_manufacturers
    get '/categories/:category/manufacturers/:manufacturer_name', to: 'products#get_models_by_manufacturer', as: :category_manufacturer_models
    get '/categories/:category/manufacturers/:manufacturer_name/models/:model_name', to: 'products#variations', as: :category_manufacturer_model_variations
    get '/categories/:category/manufacturers/:manufacturer_name/models/:model_name/sizes', to: 'products#sizes', as: :category_manufacturer_model_sizes
  end
  ...
  namespace :api do
    namespace :v1 do
      ...
      post :facebook_login, to: "sessions#facebook"
      ...
      get :how_to_use, to: 'infos#how_to_use'
      get :privacy, to: 'infos#privacy'
      get :about, to: 'infos#about'
      get :terms, to: 'infos#terms'

      #routes for people controller
      post :signup, to: "people#create"
      patch :verify, to: "people#verify"
      post :request_new_password, to: "people#request_new_password"
      patch :update_password, to: "people#update_password"
      get :check_email_availability_and_validity, to: "people#check_email_availability_and_validity"
      get :check_username_availability, to: "people#check_username_availability"
      get :resend_confirmation_code, to: "people#resend_confirmation_code"
      resources :people, except: [ :create, :index ] do
        member do
          get :show_listings
          get :person_follow_status
          get :mutual_friends
          get :wishlists
        end
      end
      ...
      resources :listings do
        ...
        collection do
          get :search
          post :create_listing_image
          post :follow_unfollow_listing_emails
          post :contact_via_listing
          get  :listing_suggestion
          get  :get_fields_from_title 
          get  :get_models_by_manufacturer  
          get  :get_container_sizes_by_model
          get  :search_suggestion      
        end
      end
      patch "listing/:id/will_or_not_willing_to_piece", to: "listings#will_or_not_willing_to_piece" 
      get   "listing/:id/follow_status/:follower_id", to: "listings#listing_follow_status"     
      ...
      get "categories/:id/custom_fields", to: "categories#show"

      #routes for settings
      patch "profile/:id/settings/profile_info", to: "settings#profile_info"
      patch "profile/:id/settings/update_email", to: "settings#update_email"
      patch "profile/:id/settings/update_password", to: "settings#update_password"
      delete "profile/:id/destroy", to: "settings#destroy_person"
      patch "profile/:id/settings/notification", to: "settings#notifications"
      patch "profile/:id/settings/payments", to: "settings#payments"
      resources :settings do
        collection do
          get :get_profile_info
          get :get_account
          get :get_notifications
          delete :delete_account_email
          post :create_payment_info
      ...
      #routes for person_messages controller
      resources :person_messages, only: [:create]
      ...
      post "/contact_us", to: "feedbacks#contact_us"

      #routes for comments
      post "listing/create_comment", to: "comments#create"
      delete "listing/delete_comment", to: "comments#destroy"

      #routes for preauthorize_transactions
      post "listing_price_break_down/:id", to: "preauthorize_transactions#price_breake_down"
      post "listing/:id/transaction_initiated", to: "preauthorize_transactions#initiated"

      #routes for accept_preauthorized_conversations
      put "transaction/:id/accepted_or_rejected", to: "accept_preauthorized_conversations#accepted_or_rejected"
    
      #routes for confirm_conversations
      put "transaction/:id/mark_as_complete_or_dispute", to: "confirm_conversations#confirmation"

      #routes for Testimonials
      post "transaction/:id/create_testimonial", to: "testimonials#create"
      put "transaction/:id/skip_testimonail", to: "testimonials#skip"


      #routes for payment_settings
  ...
  # get '/swagger/api' => redirect('/swagger/dist/index')
  mount SwaggerUiEngine::Engine, at: "/swagger_api"
  ...
  get :suggestion, to: 'homepage#suggestion'
  get :listing_suggestion, to: 'listings#listing_suggestion'
  get :validate_listing_title, to: 'listings#validate_listing_title'
  get :get_fields_from_title, to: 'listings#get_fields_from_title'
  post :will_or_not_willing_to_piece, to: "listings#will_or_not_willing_to_piece"
  ...
  scope "(/:locale)", :constraints => { :locale => locale_matcher } do
    ...
    post "/listings/:parent_id/add_child_listings", to: 'listings#add_child_listings_to_multi_listing', as: :add_child_listings
    get "/listings/rig_category_ids", to: 'listings#rig_category_ids', as: :rig_category_ids
    get "/listings/:parent_id/remove_listing_from_rig/:id/:type", to: 'listings#remove_listing_from_rig', as: :remove_listing_from_rig
    ...
    post "listings/:listing_id/select_shipping_rate" => "preauthorize_transactions#select_shipping_rate", as: :select_shipping_rate
