...
FactoryGirl.define do
  ...
  factory :category do
    ...
    factory :canopies do 
      ...
      after(:create) do |category, evaluator|
        FactoryGirl.create_list(:category_translation, evaluator.translation_count, category: category, name: "Canopies" )
        category.reload
      end
    end
  end
  ...
  factory :variation do 
    product
    factory :variation_size do 
      attribute_name "size"
      value { "#{Faker::Number.between(100,400)}" }
    end
    factory :variation_color do 
  ...
  factory :product do 
    ...
    model "Pilot"
    factory :product_with_variations do 
      model "Pilot II"
      transient do 
        variations_count 10
      end
      after(:create) do |product, evaluator|
        FactoryGirl.create_list(:variation_size, evaluator.variations_count, product: product)
        FactoryGirl.create_list(:variation_color, evaluator.variations_count, product: product)
        product.reload
      end
    end
  end
