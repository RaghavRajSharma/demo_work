    ...
    module Entity
      ...
      def transaction(transaction_model)
        ...
        Transaction[EntityUtils.model_to_hash(transaction_model).merge({
          ...
          tax: transaction_model.tax,
          shipping_tracking_number: transaction_model.shipping_tracking_number,
      ...
      def calculate_total(transaction_model)
        ...
        tax              = m_transaction.tax.or_else(0)
        (unit_price * quantity) + shipping_price + tax
      end
    end
